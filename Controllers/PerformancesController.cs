...
namespace EloGame.Controllers
{
    public class PerformancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,startElo,endElo,position")] Performance performance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,startElo,endElo,position")] Performance performance)
        {
